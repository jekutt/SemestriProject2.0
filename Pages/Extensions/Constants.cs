...
namespace SemestriProject.Pages.Extensions
{
    public static class Constants
    {
        ...
        public const string BalticsMenuTitle = "Baltics";
        public const string RussiaAndCISMenuTitle = "Russia And CIS";
        public const string ScandinaviaMenuTitle = "Scandinavia";
